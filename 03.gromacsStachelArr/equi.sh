...
gmx grompp -f ${mini_prefix}.mdp -o ${mini_prefix}.tpr -c ${init}.gro -p topol.top -n index.ndx -maxwarn 10 -r ${init}.gro
gmx mdrun -v -deffnm ${mini_prefix} -ntomp 16
...
while ( ${cnt} <= ${cntmax} )
    ...
    gmx grompp -f ${istep}.mdp -o ${istep}.tpr -c ${pstep}.gro -r ${rest_prefix}.gro -p topol.top -n index.ndx -maxwarn 10
    gmx mdrun -v -deffnm ${istep} -ntomp 10 -bonded gpu -nb gpu -pme gpu
    @ cnt += 1
end
...
#        gmx grompp -f ${prod_prefix}.mdp -o ${istep}.tpr -c ${pstep}.gro -p topol.top -n index.ndx -maxwarn 10
#	else
#        gmx grompp -f ${prod_prefix}.mdp -o ${istep}.tpr -c ${pstep}.gro -t ${pstep}.cpt -p topol.top -n index.ndx -maxwarn 10
#	endif
#    gmx mdrun -v -deffnm ${istep} -ntomp 16 -bonded gpu -nb gpu -pme gpu
#    @ cnt += 1
#end
